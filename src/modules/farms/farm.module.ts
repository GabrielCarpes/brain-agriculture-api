...
import { PrismaFarmRepository } from './application/domain/repositories/prisma/prisma-farm.repository';
import { DatabaseModule } from '@shared/database/database.module';
import { FarmRepository } from './application/domain/repositories/farm.repository';
